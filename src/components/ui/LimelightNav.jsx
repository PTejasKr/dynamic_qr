  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex flex-wrap justify-center items-center gap-4 w-full px-4 sm:w-auto">
      ...
      {status === "loading" ? null : session ? (
        <button
          onClick={() => signOut()}
          className="p-2.5 px-4 bg-red-100 rounded-full border-[3px] border-foreground text-foreground font-bold text-sm hover:-translate-y-1 shadow-[4px_4px_0_var(--foreground)] active:translate-y-0 active:shadow-none"
        >
          Sign Out
        </button>
      ) : (
        <button
          ...
          className="p-2.5 px-4 bg-white rounded-full border-[3px] border-foreground text-foreground font-bold text-sm flex items-center gap-2 hover:-translate-y-1 shadow-[4px_4px_0_var(--foreground)] active:translate-y-0 active:shadow-none"
        >
